...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('view/css/AdminLTE.min.css') }}">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{ asset('view/css/skins/_all-skins.min.css') }}">
    <!-- Morris chart -->
    ...
    <!-- BOOTSTRAP INPUT -->
    <link rel="stylesheet" href="{{ asset('tagsinput/bootstrap-tagsinput-latest/src/bootstrap-tagsinput.css') }}">
    <!-- jquery-confirm -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{ asset('view/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                </div>
...
<!--  BOOTSTRAP INPUT -->
<script src="{{ asset('tagsinput/bootstrap-tagsinput-latest/src/bootstrap-tagsinput.js') }}"></script>
<!-- jQuery UI 1.11.4 -->
...
<!-- AdminLTE App -->
<script src="{{ asset('view/js/adminlte.min.js') }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('view/js/pages/dashboard.js') }}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ asset('view/js/demo.js') }}"></script>
